...
const benchmarks = [
  ...
  },
  {
    name: 'propOr',
    benchmarks: () => ({
      soles: () => S.propOr(0, 'kDoesNotExist', obj),
  ...
  },
  {
    name: 'modifyProp',
    benchmarks: () => ({
      soles: () => S.modifyProp('k1', (x) => x + 1, obj),
